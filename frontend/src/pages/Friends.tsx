        ...
        <>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex gap-2 sm:gap-4 mt-4 sm:mt-6 border-b overflow-x-auto scrollbar-hide">
                            ...
                            <button
                                ...
                                className={`px-3 sm:px-4 py-2 sm:py-3 font-medium transition-colors whitespace-nowrap flex items-center gap-2 text-sm sm:text-base ${
                                    activeTab === 'incoming'
                                        ? 'border-b-2 border-green-600 text-green-600'
                                        : 'text-gray-600 hover:text-gray-900'
                                        }`}
                                    >
                                        ...
                                        {incoming.length > 0 && (
                                    <span
                                        className="min-w-[18px] h-[18px] sm:min-w-[20px] sm:h-[20px] bg-red-500 text-white text-[10px] sm:text-xs rounded-full flex items-center justify-center px-1">
                                      {incoming.length}
                                    </span>
                                )}
                            </button>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                                            ...
                                            <div key={u.id}
                                                ...
                                                <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
                                                    {avatarUrl === '/default.png' ? (
                                                        <div
                                                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm sm:text-lg flex-shrink-0">
                                                            {initials}
                                                        </div>
                                                    ) : (
                                                        <img
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <div
                                                            className="font-semibold text-gray-900 text-sm sm:text-base truncate">{fullName}</div>
                                                        <div
                                                            className="text-xs sm:text-sm text-gray-500 truncate">{u.email}</div>
                                                    </div>
                                                </div>
                                                <div className="flex gap-2 w-full sm:w-auto justify-end">
                                                    {status === 'friend' ? (
                                                        <span
                                                            className="flex items-center gap-2 text-xs sm:text-sm bg-green-100 text-green-700 px-3 sm:px-4 py-1. 5 sm:py-2 rounded-lg font-medium">
                                                            <UserCheck className="w-3. 5 h-3.5 sm:w-4 sm:h-4"/>
                                                            Amigos
                                                        </span>
                                                    ) : status === 'request_sent' ? (
                                                        <span
                                                            className="flex items-center gap-2 text-xs sm:text-sm bg-gray-100 text-gray-700 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg">
                    ...
                    {activeTab === 'incoming' && (
                        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
                            <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-gray-900">Solicitudes
                                Recibidas</h2>
                            {loadingIncoming ? (
                                <div className="flex items-center justify-center py-12">
                                    <Loader2 className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 animate-spin"/>
                                ...
                                <div className="grid gap-3 sm:gap-4">
                                    {incoming.map((req) => {
                                        ...
                                        return (
                                            <div key={req.id}
                                                 className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200 gap-3">
                                                <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
                                                    {avatarUrl === '/default.png' ? (
                                                        <div
                                                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-bold text-sm sm:text-lg flex-shrink-0">
                                                            {initials}
                                                        </div>
                                                    ) : (
                                                        <img
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <div
                                                            className="font-semibold text-gray-900 text-sm sm:text-base truncate">{fullName}</div>
                                                        <div className="text-xs sm:text-sm text-gray-600">Quiere ser tu
                                                            amigo
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        return (
                                            <div key={req.id}
                                                ...
                                                <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
                                                    {avatarUrl === '/default.png' ? (
                                                        <div
                                                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-white font-bold text-sm sm:text-lg flex-shrink-0">
                                                            {initials}
                                                        </div>
                                                    ) : (
                                                        <img
                            ...
                            {loadingFriends ? (
                                ...
                                <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                                    {friends.map((f) => {
                                        ...
                                        return (
                                            <div key={f.id}
                                                 className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 gap-3">
                                                <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
                                                    {avatarUrl === '/default.png' ? (
                                                        <div
                                                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm sm:text-lg flex-shrink-0">
                                                            {initials}
                                                        </div>
                                                    ) : (
                                                        <img
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <div
                                                            className="font-semibold text-gray-900 text-sm sm:text-base truncate">{fullName}</div>
                                                        <div
                                                            className="text-xs sm:text-sm text-gray-600 truncate">{f.email}</div>
                                                    </div>
                                                </div>
                                                <div className="flex gap-2 w-full sm:w-auto justify-end">
                                                    <button
