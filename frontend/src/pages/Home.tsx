        ...
        <div className="min-h-screen grid grid-rows-[auto_1fr_auto] bg-gray-100">
            ...
            <header className="
                ...
                <div className="flex items-center justify-between gap-4">
                    <h1 onClick={() => navigate("/")} className="text-xl sm:text-2xl font-bold text-green-600 cursor-pointer hover:text-green-700 transition-colors" > Sena Conecta </h1>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                            ...
                            <div className="flex items-center gap-3 pb-6 border-b border-gray-200">
                                {avatarSrc ? (
                                    ...
                                    <div
                                        className="w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center text-white font-bold text-xl ring-2 ring-green-500 ring-offset-2">
                                        {displayName.charAt(0).toUpperCase()}
                                    </div>
                                )}
            ...
            <main
                className="grid grid-cols-1 lg:grid-cols-[280px_1fr] xl:grid-cols-[320px_1fr] gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
                ...
                <aside className="hidden lg:block space-y-6">
                    <div className="sticky top-24 space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-4 lg:p-6 border border-gray-100">
                            <div className="flex items-center gap-3 lg:gap-4 mb-4 lg:mb-6">
                                {avatarSrc ? (
                                    ...
                                    <div
                                        className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center text-white font-bold text-lg lg:text-2xl shadow-lg">
                                        {displayName.charAt(0).toUpperCase()}
                                    </div>
                                )}
                                <div className="flex-1 min-w-0">
                                    <strong
                                        className="text-base lg:text-lg block text-gray-900 truncate">{displayName}</strong>
                            ...
                            <div className="grid gap-2 lg:gap-3">
                                ...
                                >
                                    <Users
                                        className="w-4 h-4 lg:w-5 lg:h-5 text-green-600 group-hover:scale-110 transition-transform"/>
                                    <span
                                        className="font-medium text-sm lg:text-base text-gray-700 group-hover:text-green-700">Amigos</span>
                                </button>
                                <button
                                ...
                                >
                                    <MessageCircle
                                        className="w-4 h-4 lg:w-5 lg:h-5 text-blue-600 group-hover:scale-110 transition-transform"/>
                                    <span
                                        className="font-medium text-sm lg:text-base text-gray-700 group-hover:text-blue-700">Chat</span>
                                </button>
                            </div>
                        </div>
                        ...
                        {/* EVENTOS CARD */}
                        <div
                            className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-4 lg:p-6 text-white relative overflow-hidden">
                            <div
                            ...
                            <div className="relative z-10">
                                <div
                                    className="flex items-center justify-center w-12 h-12 lg:w-16 lg:h-16 bg-white bg-opacity-20 rounded-full mb-3 lg:mb-4 backdrop-blur-sm">
                                ...
                                <div
                                    className="mt-3 lg:mt-4 flex items-center justify-center gap-2 text-xs text-green-100">
